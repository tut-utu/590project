...
class keras_model():
    ...
    def __init__(self,max_len:int,vocab_len:int,embedding_size:int=256,input_size:int=4096,activation:str='relu'):
        self._vocab_len = vocab_len
        self._sentence_len = max_len
        ...
        self._image_model.add(RepeatVector(self._sentence_len))
        self._caption_model.add(Embedding(self._vocab_len,self._embedding_size, input_length=self._sentence_len))
